                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p>Došlo je do greške prilikom Vaše registracije, molimo Vas da se obratite
                                                administratoru sistema!</p>

                                            <div class="form-group">
                                                <a href="<?php echo base_url('login'); ?>" id="btnRegistration"
                                                    class="btn btn-sm btn-block btn-warning" tabindex="4">IDI NA
                                                    STRANICU ZA PRIJAVU</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
